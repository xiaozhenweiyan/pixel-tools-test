...
(function () {
  ...
  const translations = {
    zh: {
      ...
      tutorial_pixel_ai: '<h3>使用教程</h3><h3>第一步：获取 API Key</h3><p>访问您选择的 AI 服务商网站，注册账号并获取 API Key。</p><ul><li>OpenAI: https://platform.openai.com/api-keys</li><li>Anthropic: https://console.anthropic.com/settings/keys</li><li>Google: https://aistudio.google.com/app/apikey</li><li>通义千问: https://dashscope.console.aliyun.com/apiKey</li><li>文心一言: https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application</li><li>DeepSeek: https://platform.deepseek.com/api_keys</li><li>Mistral: https://console.mistral.ai/api-keys/</li><li>Groq: https://console.groq.com/keys</li></ul><h3>第二步：配置模型</h3><p>点击右上角「设置」按钮，选择模型提供商、模型版本，然后输入您的 API Key。</p><h3>第三步：开始对话</h3><p>在底部输入框中输入您的问题，按 Enter 发送。Shift+Enter 换行。</p><h3>常见错误及解决方法</h3><ul><li><strong>认证失败：</strong>检查 API Key 是否正确，没有多余空格或换行符。</li><li><strong>请求参数错误：</strong>检查模型名称是否正确，或输入内容格式是否有误。</li><li><strong>请求过于频繁：</strong>API 调用次数超过限制，请稍后再试或升级套餐。</li><li><strong>跨域错误：</strong>检查 API Base URL 是否正确，有些服务商需要使用特定的 API 地址。</li><li><strong>服务器错误：</strong>服务商服务器暂时不可用，请稍后重试。</li><li><strong>网络错误：</strong>检查网络连接，确保可以访问互联网。</li></ul>',
      tutorial_btn: '教程',
      tutorial_title: '教程',
    ...
    en: {
      ...
      tutorial_pixel_ai: '<h3>User Guide</h3><h3>Step 1: Get API Key</h3><p>Visit your chosen AI provider website, register an account, and obtain an API Key.</p><ul><li>OpenAI: https://platform.openai.com/api-keys</li><li>Anthropic: https://console.anthropic.com/settings/keys</li><li>Google: https://aistudio.google.com/app/apikey</li><li>Qwen: https://dashscope.console.aliyun.com/apiKey</li><li>ERNIE: https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application</li><li>DeepSeek: https://platform.deepseek.com/api_keys</li><li>Mistral: https://console.mistral.ai/api-keys/</li><li>Groq: https://console.groq.com/keys</li></ul><h3>Step 2: Configure Model</h3><p>Click the "Settings" button in the top right corner, select the AI provider and model version, then enter your API Key.</p><h3>Step 3: Start Chatting</h3><p>Enter your question in the bottom input box, press Enter to send. Shift+Enter for newline.</p><h3>Common Errors and Solutions</h3><ul><li><strong>Authentication Failed:</strong> Check if your API Key is correct, with no extra spaces or line breaks.</li><li><strong>Bad Request:</strong> Check if the model name is correct, or if the input format is invalid.</li><li><strong>Rate Limit Exceeded:</strong> API call limit exceeded. Please try again later or upgrade your plan.</li><li><strong>CORS Error:</strong> Check if the API Base URL is correct. Some providers require specific API endpoints.</li><li><strong>Server Error:</strong> The provider\'s server is temporarily unavailable. Please try again later.</li><li><strong>Network Error:</strong> Check your network connection and ensure you have internet access.</li></ul>',
